    ...
    <div class="instructor-layout">
        ...
        <div class="instructor-main">
                ...
                <form method="POST" id="courseForm">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--spacing-6); margin-bottom: var(--spacing-6);">
                        ...
                        <div class="instructor-form-group">
                            ...
                            <select name="category" id="category" class="instructor-form-input instructor-form-select">
                                <option value="general" <?= $course['category'] == 'general' ? 'selected' : '' ?>>Général</option>
                                <option value="technology" <?= $course['category'] == 'technology' ? 'selected' : '' ?>>Technologie</option>
                                ...
                                <option value="languages" <?= $course['category'] == 'languages' ? 'selected' : '' ?>>Langues</option>
                                <option value="other" <?= $course['category'] == 'other' ? 'selected' : '' ?>>Autre</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; gap: var(--spacing-4); align-items: center;">
                        ...
                        <div style="margin-left: auto; display: flex; gap: var(--spacing-2);">
                            <a href="course_lessons.php?course_id=<?= $course_id ?>" class="instructor-btn instructor-btn-success">
                                <i class="fas fa-play"></i>
                                Gérer les leçons
                            </a>
                            
                            <a href="course_students.php?course_id=<?= $course_id ?>" class="instructor-btn instructor-btn-info">
                                <i class="fas fa-users"></i>
                                Voir les étudiants
                            </a>
                        </div>
            ...
            <div style="margin-top: var(--spacing-8); display: flex; gap: var(--spacing-4); flex-wrap: wrap;">
                ...
                <a href="course_stats.php?course_id=<?= $course_id ?>" class="instructor-btn instructor-btn-info">
